...
/**
 * An implementation of {@link EjbServices} which forwards all its method calls to another {@link EjbServices} . Subclasses
 * should override one or more methods to modify the behavior of the backing {@link EjbServices} as desired per the <a
