...
/**
 * An {@link AnnotationDiscovery} implementation may optionally implement this interface.
 *
...
public interface ExtendedAnnotationDiscovery extends AnnotationDiscovery {
     ...
     * @return a collection of fully qualified class names of annotation types which are annotated with the given annotation
     */
